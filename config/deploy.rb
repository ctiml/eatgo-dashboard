...
set :application, "eatgo-dashboard"
...
role :web, "eatgo-dashboard.com"                          # Your HTTP server, Apache/etc
role :app, "eatgo-dashboard.com"                         # This may be the same as your `Web` server
role :db,  "eatgo-dashboard.com"   , :primary => true # This is where Rails migrations will run
